...
export const MEALS = [
  ...
  new Meal(
    ...
    [
      ...
      'Bake the toast for round about 10 minutes in the oven at 200簞C',
    ],
    false,
    false,
    false,
  ...
  new Meal(
    ...
    [
      ...
      'Make sure to toss the pan regularly so that the schnitzels are surrounded by oil and the crumbing becomes �侰luffy��.',
  ...
  new Meal(
    ...
    [
      ...
      'Process onion, garlic and ginger into paste and saut矇 everything',
  ...
  new Meal(
    ...
    [
      'Preheat oven to 190簞C. Line a rimmed baking sheet with parchment paper.',
